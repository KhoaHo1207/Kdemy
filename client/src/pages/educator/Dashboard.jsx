...
const Dashboard = () => {
  ...
  const fetchDashobardData = async () => {
  ...
  return dashboarData ? (
    <div className="min-h-screen flex flex-col items-start justify-between gp-8 md:p-8 md:pb-0 p-4 pt-8 pb-0">
          ...
          <div className="flex items-center gap-3 shadow-custom-card border border-blue-500 p-4 w-56 rounded-md">
            ...
            <div>
              <p className="text-2xl font-medium text-gray-600">
                {dashboarData?.enrolledStudentsData.length}
              </p>
